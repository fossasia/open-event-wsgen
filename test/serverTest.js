...
describe('fold', function() {
  ...
  describe('extractEventUrls()' , function () {
    it('should return event and logo urls', function () {
      const linkModeUrls = fold.extractEventUrls(data.event.json, {assetmode:'link'});
      const downloadModeUrls = fold.extractEventUrls(data.event.json, {assetmode:'download', email:"a@b.com", name:"testapp"});
